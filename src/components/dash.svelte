    <script>
        ...
        export let content = 'Hello, Pleas Login to continue';
    </script>
    <svelte:head>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Artemis <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/register/faculty" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-person-chalkboard"></i>
                    <span>Register Faculty</span>
                </a>
                <a class="nav-link collapsed" href="/register/student" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/semester" data-toggle="collapse" data-target="#collapseUtilities"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-building-columns"></i>
                    <span>Semester</span>
                </a>
                <a class="nav-link collapsed" href="/subjects" data-toggle="collapse" data-target="#collapseUtilities"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-note-sticky"></i>
                    <span>Subjects</span>
                </a>
                <a class="nav-link collapsed" href="/exams" data-toggle="collapse" data-target="#collapseUtilities"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-pencil"></i>
                    <span>Exams</span>
                </a>
                <a class="nav-link collapsed" href="/attendence" data-toggle="collapse" data-target="#collapseUtilities"
                aria-expanded="true" aria-controls="collapseUtilities">
                <i class="fas fa-fw fa-pencil"></i>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/downloads" data-toggle="collapse" data-target="#collapsePages"
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <span class="nav-link" on:click={()=>{logoutUser()}} > <i class="fas fa-fw fa-right-from-bracket"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><p>Hello {$user.name}</p></span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Artemis 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
.bg-login-image {
  background: url("https://source.unsplash.com/random/600x800");
